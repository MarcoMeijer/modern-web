    ...
    <ul class="flex flex-col">
        ...
        <li class="flex flex-row bg-slate-100 rounded-md shadow-lg p-1 m-2">
            <class class="flex flex-col w-48 items-center border-r border-slate-300 p-4">
                ...
                <span class="text-xs text-slate-500 p-1 text-center border-t border-slate-200">Member since <br /> {{$comment->author->email_verified_at}}</span>
            ...
            <class class="flex flex-col flex-1 p-2">
                ...
                <div class="flex border-t border-slate-200 mx-2 pt-1">
                    <span class="flex flex-initial font-serif text-xs text-slate-400">Posted at {{$comment->published_at}}</span>
                    <div class="flex flex-1"></div>
