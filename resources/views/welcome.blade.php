    ...
    <x-white-box class="p-6 flex-col space-y-6">
        <div class="flex flex-row justify-center items-center">
            <div class="flex flex-col space-y-4 w-96 m-8">
                <h2 class="text-lg font-medium text-gray-900">MultiWorlds</h2>
        ...
        <div class="flex flex-row justify-center items-center">
            ...
            <div class="flex flex-col space-y-4 w-96 m-8">
                <h2 class="text-lg font-medium text-gray-900">Current features</h2>
        ...
        <div class="flex flex-row justify-center items-center">
            <div class="flex flex-col space-y-4 w-96 m-8">
                <h2 class="text-lg font-medium text-gray-900">Community</h2>
                <p class="mt-1 text-sm text-gray-600">
